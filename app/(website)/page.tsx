  ...
  return (
    <div className="w-[75%] max-md:w-[85%] mx-auto">
      <div className="w-[65%] max-md:w-full flex items-start flex-col mr-auto mb-[150px] max-md:mb-[100px] pt-[135px] max-md:pt-[60px]">
        <section aria-label="homepage-intro" className="mb-[55px] max-md:mb-[40px] text-left">
        ...
        <section aria-label="homepage-signup" className="w-full flex flex-col items-start">
